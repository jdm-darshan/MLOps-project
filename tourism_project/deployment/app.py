...
Occupation = st.selectbox("Contact Type (How customer was contacted)", ["Salaried", "Small Business", "Large Business", "Free Lancer"])
...
NumberOfChildrenVisiting = st.number_input("No of person Accompanying customer")
